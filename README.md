...
| global | object | `{"image":{},"rollingUpdate":{},"searchEngine":{"semanticIndexer":{"knnVectorFieldConfig":{"compressionLevel":null,"dimension":768,"efConstruction":100,"efSearch":100,"encoder":{"clip":false,"name":"sq","type":"fp16"},"m":16,"mode":"in_memory","spaceType":"l2"},"numberOfReplicas":0,"numberOfShards":1}}}` | only for providing appropriate default value for helm lint |
...
| minioConfig.defaultDatasetBucket | string | `"magda-datasets"` |  |
| minioConfig.endPoint | string | `"minio"` |  |
...
| semanticIndexer.bulkEmbeddingsSize | int | `1` |  |
| semanticIndexer.bulkIndexSize | int | `50` |  |
| semanticIndexer.chunkSizeLimit | int | `512` | The maximum number of tokens in a single chunk. |
| semanticIndexer.indexName | string | `"semantic-index"` |  |
| semanticIndexer.indexVersion | int | `1` | System wide agreed version |
| semanticIndexer.overlap | int | `50` | The number of overlapping tokens between chunks. |
